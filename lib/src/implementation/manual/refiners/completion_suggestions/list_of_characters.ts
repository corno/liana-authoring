...
import * as t_unmashall_result_to_completion_suggestions from "../../transformers/unmarshall_result/completion_suggestions"
...
export const Document: Document = ($, abort, $p) => {
    return t_unmashall_result_to_completion_suggestions.Document(
