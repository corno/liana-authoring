                                        ...
                                        case 'wrong type': return p_.ss($, ($) => p_.literal.list([
                                            {
                                                ...
                                                'type': ['value', ['invalid type', {
                                                    'expected': p_.from.state(def).decide(
                                                ...
                                                ($): d_out.Errors => {
                                                    switch ($[0]) {
                                                        ...
                                                        case 'error': return p_.ss($, ($) => p_.from.state($).decide(
                                                            ($) => {
                                                                switch ($[0]) {
                                                                    case 'duplicate': return p_.ss($, ($) => p_.from.list($.instances).map(
                                                                        ($): d_out.Errors.L => ({
                                        ...
                                        ($, id): d_out.Errors => {
                                            return p_.from.state($.result).decide(
                                                ($) => {
                                                    switch ($[0]) {
                                                        case 'success': return p_.ss($, ($) => p_.literal.list([]))
                                                        case 'error': return p_.ss($, ($): d_out.Errors => p_.from.state($).decide(
                                                            ($): d_out.Errors => {
                                                                switch ($[0]) {
                                                                    ...
                                                                    case 'multiple': return p_.ss($, ($) => p_.from.list($.instances).map(
                                                                        ($): d_out.Errors.L => ({
                                                                            'range': $.intermediate['id value pair'].id.range,
