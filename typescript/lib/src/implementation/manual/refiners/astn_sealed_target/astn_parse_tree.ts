...
//signatures
export type Document = pi.Refiner_With_Parameter<d_out.Document, d_function.Error, d_in.Document, d_function.Parameters>
export type Value = pi.Refiner_With_Parameter<d_out.Value, d_function.Error, d_in.Value, d_function.Parameters>
