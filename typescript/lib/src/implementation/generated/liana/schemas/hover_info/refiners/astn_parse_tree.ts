...
import * as t_signatures from "../../../../../../interface/generated/liana/schemas/hover_info/signatures/refiners/astn_parse_tree.js"

import * as t_out from "../../../../../../interface/generated/liana/schemas/hover_info/data.js"
...
export const Hover_Texts: t_signatures.Hover_Texts = ($, abort) => p_.from.list(v_unmarshalled_from_parse_tree.List(
        $,
        ($) => abort(
            $,
        ),
